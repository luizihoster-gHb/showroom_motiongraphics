...
function initAnimations() {
  ...
  tt.set('.banner', { display: 'block' })
    .set('#cta', { scale: 1, transformOrigin: '150px 463px' })
    .set(['#device1', '#device2'], { y: '+=600', })
	  .set('#device3', { y: '-=600', })
    ...
    .to('#device1', { duration: 1, y: '-=600', ease: 'power3.inOut' }, 'f3')
    ...
    .to('#device2', { duration: 1, y: '-=600', ease: 'power3.inOut' }, 'f4')
    ...
    .to('#device3', { duration: 1, y: '+=600', ease: 'power3.inOut' }, 'f5')

    .addLabel('f6', 12.5)
    //.set("#icon",{scale:1,opacity:1,x:"-=300"},'f6')
	.set("#icon", { scale: 6, opacity: 1, x: "0", y: '0' }, 'f6')
    ...
    //.to('#icon', { duration: 2, rotation: "-=120", ease: 'back.inOut(.65)' }, 'f6+=.5')  
